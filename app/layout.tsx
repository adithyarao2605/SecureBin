...
export default async function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  const themeScript = `try{var t=localStorage.getItem("securebin-theme");if(t==="light"||t==="dark"){document.documentElement.className=t;document.documentElement.dataset.theme=t;}else{document.documentElement.className="light";document.documentElement.dataset.theme="light";}}catch(e){}`;
