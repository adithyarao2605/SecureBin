            ...
            <div className="principles-grid">
              <article className="principle-card">
                <div className="principle-card-top">
                  ...
                  <span className="principle-tag">Client Boundary</span>
                </div>
                <h3>Local first</h3>
                <p>
              ...
              <article className="principle-card">
                <div className="principle-card-top">
                  ...
                  <span className="principle-tag">Enforcement</span>
                </div>
                <h3>Explicit access policy</h3>
                <p>
                  Availability schedules, reveal limits, expiration, and revocation are enforced atomically at the database row level—not client-side suggestions.
                </p>
              </article>
              ...
              <article className="principle-card">
                <div className="principle-card-top">
                  ...
                  <span className="principle-tag">Transparency</span>
                </div>
                <h3>Plain language</h3>
                <p>
                  The server stores only a sealed ciphertext parcel and bounded metadata. Expired, missing, or revoked shares fail with a uniform unavailable state.
                </p>
              </article>
            </div>
          </section>
