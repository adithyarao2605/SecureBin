...
select has_function('public', 'create_share', array['text','jsonb','timestamp with time zone','timestamp with time zone','integer','bytea','boolean','boolean','bytea','bytea','integer'], '11-arg create_share RPC exists');
